...
const socialLinks = [
  { name: "Instagram", icon: FaInstagram, url: "https://instagram.com/arpduhrito" },
  { name: "TikTok", icon: FaTiktok, url: "https://tiktok.com/@jeffhardysnephew" },
  { name: "YouTube", icon: FaYoutube, url: "https://youtube.com/@arpduhrito" },
];
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#FF4FE0] to-[#00CFFF] flex flex-col items-center justify-center p-4 text-white font-bold font-mono overflow-hidden">
      <motion.h1
        initial={{ opacity: 0, y: -40 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
        className="text-5xl md:text-6xl mb-8 drop-shadow-lg glitch-text"
      >
        BURN THE CD 🔗
      </motion.h1>
